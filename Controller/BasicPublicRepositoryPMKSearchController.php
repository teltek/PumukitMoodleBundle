 ...
 * @Route("/pumoodle")
 */
class BasicPublicRepositoryPMKSearchController extends Controller
{
    /**
     * @Route("/basic_search_repository", defaults={"filter":false})
     */
    ...
    protected function mmobjToArray(MultimediaObject $multimediaObject, $locale = null)
    {
        ...
        if ($multimediaObject->getProperty('iframeable') === true) {
            $source = $multimediaObject->getProperty('iframe_url');
        } else {
