...
class mod_pumukit_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        //-------------------------------------------------------------------------------
        // Adding the rest of pumukit settings, spreading all them into this fieldset
        // or adding more fieldsets ('header' elements) if needed for better logic
        // $mform->addElement('static', 'label1', 'pumukitsetting1', 'Your pumukit fields go here. Replace me!');
        // $mform->addElement('header', 'pumukitfieldset', get_string('pumukitfieldset', 'pumukit'));
        // $mform->addElement('static', 'label2', 'pmukitsetting2', 'Your pumukit fields go here. Replace me!');

        // TO DO: implement user authentication between moodle and pumukit (LDAP?)
        ...
        if (!$pumukit_out) {
            ...
            $pumukit_list = array($pumukit_out['status_txt'] => null);
        } else {
