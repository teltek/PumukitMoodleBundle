...
$module->version   = 2016020201;    // The current module version (Date: YYYYMMDDXX)
$module->requires  = 2011051000;    // Requires this Moodle version
$module->cron      = 0;             // Period for cron to check this module (secs)
$module->component = 'mod_pmkurlvideos'; // To check on upgrade, that module sits in correct place
