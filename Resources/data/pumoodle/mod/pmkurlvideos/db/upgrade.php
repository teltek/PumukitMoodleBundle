...
function xmldb_pmkurlvideos_upgrade($oldversion)
{
    ...
    // for demonstrative purposes and to show how the pmkurlvideos
    // iself has been upgraded.

    // For each upgrade block, the file pmkurlvideos/version.php
    ...
    if ($oldversion < 2007040100) {
        ...
        // // Define field introformat to be added to pmkurlvideos
        // $table = new xmldb_table('pmkurlvideos');
        ...
        upgrade_mod_savepoint(true, 2007040100, 'pmkurlvideos');
    }
    ...
    if ($oldversion < 2007040101) {
        ...
        // Define field timemodified to be added to pmkurlvideos
        $table = new xmldb_table('pmkurlvideos');
        ...
        // Define index course (not unique) to be added to pmkurlvideos
        $table = new xmldb_table('pmkurlvideos');
        ...
        upgrade_mod_savepoint(true, 2007040101, 'pmkurlvideos');
    }
