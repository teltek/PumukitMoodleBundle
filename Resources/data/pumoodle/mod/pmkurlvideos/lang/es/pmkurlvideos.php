...
/**
 * English strings for pmkurlvideos.
 *
...
$string['modulename'] = 'PuMuKIT: Video desde Url.';
$string['modulenameplural'] = 'PuMuKIT: Videos desde Urls.';
...
$string['pumukitname'] = 'Nombre del vídeo en el curso';
$string['pumukitname_'] = 'Nombre del vídeo en el curso';
$string['pumukitname_help'] = 'Establece el nombre de este recurso dentro del curso';
$string['pumukit'] = 'Pumukit';
$string['pluginadministration'] = 'pumukit administration';
$string['pluginname'] = 'PuMuKIT: Videos desde URLs';
...
$string['pmkurlvideos'] = 'URL del servidor Pumukit';
$string['configpmkurlvideos'] = 'Moodle se conectará a este endpoint para consultar al servidor Pumukit';
...
$string['updatemetadata_b'] = 'Actualizar Metadatos';
